...
public class Main extends BaseActivity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (item_id == R.id.main_menu_user) {
			UIHelper.loginOrLogout(this);
		} else if (item_id == R.id.main_menu_about) {
			UIHelper.showAbout(this);
		} else if (item_id == R.id.main_menu_setting) {
			UIHelper.showSetting(this);
		} else if (item_id == R.id.main_menu_exit) {
			UIHelper.Exit(this);
		}
		return true;
	}
